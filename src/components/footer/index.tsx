...
const Footer = () => {
  return (
    <>
      <div className="flex justify-center items-center bg-primary h-[327px] ">
        <footer className="w-content large:px-0 medium:px-[2.5rem] px-[1.5rem] max-large:w-full">
          <div className="flex gap-10 justify-between text-[#DDE3EB] py-7 flex-wrap max-medium:flex-col max-medium:items-center">
            <div className="flex flex-col flex-[1.5] gap-4 max-medium:items-center justify-center">
            ...
            <div className="flex-1 flex flex-col w-full gap-4 max-medium:items-center">
              ...
              <Link href="/Home">Home</Link>
                ...
                <Link href="/ticket">Services</Link>
            ...
            <div className="flex-1 flex flex-col w-full gap-4 max-medium:items-center">
              ...
              <div className="text-base flex flex-col gap-2 ">
                <div className="flex flex-col items-center gap-2 max-medium:justify-center">
      ...
      <div className="bg-primary flex justify-center items-center py-3 text-[#DDE3EB] border-t">
