  ...
  return (
    <div className=" flex flex-col justify-center items-center pt-5">
      ...
      <div className="flex flex-col gap-2 justify-center items-center">
          ...
          What  customers say about <span className="text-secondary">Courier</span> <span className="text-primary">Direct</span>  
          </div>
        </div>
                    ...
                    <div className="flex flex-col gap-3">
                      <div className=" flex flex-col justify-center items-center gap-3">
                        ...
                        <h2 className="text-xl font-bold text-primary">
                          ...
                          <div className="flex gap-1 items-center justify-center text-sm text-yellow-400">
                      ...
                      <p className="text-base leading-6  font-medium p-2">
                        {value.message}
                      </p>
                    </div>
                  </div>
